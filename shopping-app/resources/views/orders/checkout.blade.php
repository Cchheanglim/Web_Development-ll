                ...
                <div class="bg-white border rounded-lg p-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="shipping_phone" value="{{ old('shipping_phone') }}" required placeholder="e.g. 012 345 678"
                                   class="w-full border rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500">
                        </div>
                        <div>
                    ...
                    <div class="space-y-2">
                        @foreach($paymentMethods as $value => $label)
                            <label class="flex items-center gap-3 border rounded-md px-4 py-3 cursor-pointer hover:border-orange-400 has-[:checked]:border-orange-500 has-[:checked]:bg-orange-50">
                                <input type="radio" name="payment_method" value="{{ $value }}" @checked($loop->first)>
                                <span class="text-sm">{{ $label }}</span>
                            </label>
                        @endforeach
                    </div>
                    <p class="text-xs text-gray-400 mt-3">Demo checkout — no real payment is charged. This just records what the buyer and seller agreed to.</p>
                </div>
            </div>
